...
const Blog = () => {
  ...
  return data ? (
    <div className='relative'>
      <img src={assets.gradientBackground} alt="" className='absolute -top-52 -z-10 opacity-50' />
      <Navbar />
      ...
      <div className='mt-14 mb-10 max-w-3xl mx-auto'>
        <p className='font-semibold mb-4s'>Comments ({comments.length})</p>
       <div className='flex flex-col gap-4'>
         {comments.map((item, index) => (
          <div key={index} className='relative bg-primary/5 border border-primary/5 max-w-xl p-4 text-gray-600'>
